...
class TestPodcastDirectoryWalkerWalk(object):
    ...
    def test_single_mp3(self, mock_walk, tmpdir):
        ...
        foo = tmpdir.mkdir('foo')
        first_pod = foo.join('S01E01_first.mp3')
        ...
        assert pdw.ignored_podcasts == ['S01E01_first']
        assert pdw.podcast_files == {}
    ...
    def test_single_mp3_bad_name(self, mock_walk, tmpdir):
        ...
        assert pdw.ignored_podcasts == ['first']
        assert pdw.podcast_files == {}
